...
object AutoPot : Module("AutoPot", Category.COMBAT, hideModule = false) {
    ...
    private val healPotion by bool("HealPotion", true)
    private val regenerationPotion by bool("RegenPotion", true)
    private val fireResistancePotion by bool("FireResPotion", true)
    private val strengthPotion by bool("StrengthPotion", true)
    private val jumpPotion by bool("JumpPotion", true)
    private val speedPotion by bool("SpeedPotion", true)

    private val openInventory by bool("OpenInv", false)
    private val simulateInventory by bool("SimulateInventory", true) { !openInventory }
