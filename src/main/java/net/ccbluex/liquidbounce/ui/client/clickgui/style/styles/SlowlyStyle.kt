                        ...
                        is ColorValue -> {
                            ...
                            if (!colorValue.rainbow) {
                                ...
                                drawBorderedRect(
                                    startX - 3f,
                                    (startY - 12).toFloat(),
                                    (startX + colorPickerWidth + hueSliderWidth + 10).toFloat(),
                                    (startY + colorPickerHeight + 2).toFloat(),
                                    3f,
                                    Color(42, 57, 79).rgb,
                                    Color(54, 71, 96).rgb
                                )
                                ...
                                val inColorPicker = mouseX in startX..(startX + colorPickerWidth) && mouseY in startY..(startY + colorPickerHeight)
